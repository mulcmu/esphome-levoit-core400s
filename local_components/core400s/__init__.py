...
core400s_ns = cg.esphome_ns.namespace('core400s')
core400sComponent = core400s_ns.class_('core400sComponent', cg.PollingComponent)
...
CONFIG_SCHEMA = cv.Schema({
    cv.GenerateID(): cv.declare_id(core400sComponent),
