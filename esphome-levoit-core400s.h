...
static const char *TAG = "component.core400s_UART";

class component_core400sUART : 
  ...
  public:
    ...
    static component_core400sUART* instance(UARTComponent *parent)
    {
        static component_core400sUART* INSTANCE = new component_core400sUART(parent);
        return INSTANCE;
    }
    ...
    void set_fan_manual_turbo(void) {
  ...
  private: 
    ...
    std::vector<uint8_t> cmd_set_fan_manual_turbo  = {0XA5, 0X22, 0XFF, 0X07, 0X00, 0XFF, 0X01, 0X60, 0XA2, 0X00, 0X00, 0X01, 0X04};
    ...
    component_core400sUART(UARTComponent *parent) : PollingComponent(200), UARTDevice(parent) 
    {
        ...
        switch (packet_type) {
            ...
            case 0x01B140:
                ...
                switch(rx_buf[15]) {  //Fan Speed
                    ...
                    case 0x04:
                    textsensor_fanSpeed->publish_state("Turbo");
                    break;                    
